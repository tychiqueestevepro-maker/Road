...
export function QuickstartTimeline() {
          ...
          tabs={[
            {
              ...
              label: "cURL",
              language: "bash",
              code: `curl "https://api.verytis.dev/v1/discrepancies?latitude=37.8&longitude=-122.45&radius=5000&status=active" \\
  -H "Authorization: Bearer $VERYTIS_API_KEY"`
            },
            {
              ...
              label: "TypeScript",
              language: "typescript",
              code: `const res = await fetch("https://api.verytis.dev/v1/discrepancies?latitude=37.8&longitude=-122.45&radius=5000&status=active", {
  headers: {
...
url = "https://api.verytis.dev/v1/discrepancies?latitude=37.8&longitude=-122.45&radius=5000&status=active"
